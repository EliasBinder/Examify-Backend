...
public class ParticipantsManager {
    ...
    public synchronized static void removeSseEmitter(SseEmitter sseEmitter, String participationRef) {
        participantsStreams.getOrDefault(participationRef, new LinkedList<>()).remove(sseEmitter);
    }

    public synchronized static void addParticipant(String ref, String name, int id){
    ...
    public synchronized static void streamAllParticipants(String ref, SseEmitter emitter){
